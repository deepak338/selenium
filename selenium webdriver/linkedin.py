...
sing_in = driver.find_element(by=By.XPATH, value="/html/body/div[1]/header/nav/div/a[2]")
sing_in.click()
user_name = driver.find_element(by=By.ID, value='username')
user_name.send_keys("E-mail.id")
password = driver.find_element(by=By.ID, value="password")
password.send_keys("password")
singin_btn = driver.find_element(by=By.XPATH, value='//*[@id="organic-div"]/form/div[3]/button')
singin_btn.click()
